...
if __name__ == "__main__":
    ...
    def train_understandable(train_dataset, understanding_dataset,only_dense = False, save_path = "model"):
        ...
        history = model.fit_pretrain(train_dataset,understanding_dataset, epochs=epochs, steps_per_epoch=int(100000), tokenizer = tokenizer) #3600 datapoints for cola
...
#     tokenized_definition_train_gender = get_understanding_set(definition_pairs,tokenizer)
    ...
    train_understandable(pre_training_set,tokenized_definition_train_gender_large, save_path = ("pre_gender_test"))
